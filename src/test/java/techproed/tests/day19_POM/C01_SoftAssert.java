...
public class C01_SoftAssert {
    ...
    public void softAssert() throws InterruptedException {
        ...
        //8. "Currency" drop down menusunden Eurozone'u secin
        //önce locate alıyoruz
        //karşımıza dropdown menü geldi onun için select objesi yaptık
        //bizden istenen bilgiyi visibletextle yolladık
        ...
        //eger hata verirse diye hata mesajı versin diye"Seçili option Uygun değil" bunu yazdık
        ...
        //dropdowndaki herşeyi liste atıyoruz
        //dropdownlisti actual liste atmak için foreach yapıyoruz
